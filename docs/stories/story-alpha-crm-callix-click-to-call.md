...
| 2026-08-27 | 1.3 | Integração ajustada para resolver o login Callix pelo ID salvo; ServiceHub é aberto sob demanda em uma aba separada do navegador. | Dex |
...
- O Click-to-Call resolve o login do agente a partir do ID Callix salvo e envia `username`, formato aceito pelo tenant. O ServiceHub abre somente ao iniciar uma ligação, em uma aba separada do navegador.
