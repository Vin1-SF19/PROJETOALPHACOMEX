...
export default async function ListaParceirosPage({
  searchParams,
}: {
  searchParams: Promise<{ busca?: string; nivel?: string; estagio?: string; abrir?: string }>;
}) {
  ...
  const { busca, nivel, estagio, abrir } = await searchParams;
