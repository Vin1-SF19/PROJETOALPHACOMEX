...
export const MODULOS_REGISTRY: ModuloRegistryItem[] = [
  ...
  { id: 'calendarioAlpha',    label: 'Agenda Alpha',          href: '/PainelAlpha/CalendarioAlpha',                                                  iconName: 'CalendarClock', category: 'operacional', permission: 'calendarioAlpha',   img: '/google.png',                      desc: 'Sua agenda Google conectada ao Painel.',         tag: 'Agenda',     color: 'from-blue-600/20' },
  ...
  { id: 'apresentacoes',      label: 'Alpha Motion',          href: '/PainelAlpha/Apresentacoes',                                                iconName: 'MonitorPlay',   category: 'comercial',   permission: 'apresentacoes',      img: '/planning.png',           desc: 'Editor de apresentações interativas em HTML.',          tag: 'Studio',     color: 'from-fuchsia-600/20' },
  ...
  { id: 'comissoes',          label: 'Gestão de Comissões e Prêmios', href: '/PainelAlpha/Comissoes',                                                  iconName: 'HandCoins',     category: 'financeiro',  permission: 'comissoes',          desc: 'Controle de fatos geradores, cálculos, pagamentos e espelhos.', tag: 'Financeiro', color: 'from-emerald-600/20', allowedRoles: ['Admin', 'CEO', 'TI', 'FINANCEIRO'] },
  ...
  { id: 'notas',              label: 'Bloco de notas ALpha',  href: '/PainelAlpha/Notas',                                                            iconName: 'StickyNote',    category: 'infra',       permission: 'notas',              img: '/document.png',           desc: 'Notas privadas, compartilhadas e vinculadas a registros do painel.', tag: 'Notas', color: 'from-yellow-600/20' },
  { id: 'roadmap',            label: 'Roadmap Alpha',         href: '/PainelAlpha/Roadmap',                                                          iconName: 'Map',           category: 'infra',       permission: 'roadmap',            img: '/planning.png',           desc: 'Objetivos priorizados e documentação automática em prompt-phases.', tag: 'Roadmap', color: 'from-cyan-600/20' },
  { id: 'geradorDocumentos',  label: 'Gerador de Documentos', href: '/PainelAlpha/GeradorDocumentos',                                               iconName: 'FileText',      category: 'infra',       permission: 'geradorDocumentos', desc: 'Templates contratuais com geração, conferência e reescrita IA.', tag: 'Documentos', color: 'from-emerald-600/20' },
