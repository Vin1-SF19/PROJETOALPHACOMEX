...
export const MODULOS_REGISTRY: ModuloRegistryItem[] = [
  ...
  { id: 'comissoes',          label: 'Gestão de Comissões e Prêmios', href: '/PainelAlpha/Comissoes',                                                  iconName: 'HandCoins',     category: 'financeiro',  permission: 'comissoes',          desc: 'Controle de fatos geradores, cálculos, pagamentos e espelhos.', tag: 'Financeiro', color: 'from-emerald-600/20', allowedRoles: ['Admin', 'CEO', 'FINANCEIRO'] },
