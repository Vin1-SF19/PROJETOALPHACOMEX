...
export const MODULOS_REGISTRY: ModuloRegistryItem[] = [
  ...
  { id: 'exploradorArquivos', label: 'Alpha Explorer', href: '/PainelAlpha/ExploradorArquivos',                                                   iconName: 'FolderSearch',  category: 'infra',       permission: 'exploradorArquivos', img: '/arquivo.png',            desc: 'Arquivos privados no NAS com navegação e upload seguro.', tag: 'Storage', color: 'from-cyan-600/20', grupo: 'documentos' },
