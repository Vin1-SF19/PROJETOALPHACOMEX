...
export const MODULOS_REGISTRY: ModuloRegistryItem[] = [
  ...
  { id: 'mesclagem',          label: 'Mesclagem Planilhas',   href: '/PainelAlpha/Mesclagem',                                                        iconName: 'FileSpreadsheet', category: 'comercial', permission: 'mesclagemPlanilhas', desc: 'Mesclagem de planilhas principal e complementar por CNPJ.', tag: 'Planilhas', color: 'from-indigo-600/20', grupo: 'relacionamento' },
  { id: 'parceiros',           label: 'Parceiros',              href: '/PainelAlpha/Parceiros',                                                        iconName: 'Handshake',     category: 'comercial',   permission: 'parceiros',          allowedRoles: ['Lider Comercial'], img: '/handshake.png',          desc: 'Cadastro e gestão de parceiros PF e PJ.',               tag: 'Parceiros',  color: 'from-yellow-600/20', grupo: 'relacionamento' },
  ...
  { id: 'exploradorArquivos', label: 'Explorador de Arquivos', href: '/PainelAlpha/ExploradorArquivos',                                             iconName: 'FolderSearch',  category: 'infra',       permission: 'exploradorArquivos', img: '/arquivo.png',            desc: 'Arquivos privados no NAS com navegação e upload seguro.', tag: 'Storage', color: 'from-cyan-600/20', grupo: 'documentos' },
  ...
  { id: 'chatBotAlpha',          label: 'ChatBot Alpha',            href: '/PainelAlpha/ChatBotAlpha',                                                  iconName: 'Bot',           category: 'admin',       permission: 'chatBotAlpha',      desc: 'Workspace operacional de atendimento, automações e campanhas com dados simulados.', tag: 'ChatBot', color: 'from-emerald-600/20' },
];
