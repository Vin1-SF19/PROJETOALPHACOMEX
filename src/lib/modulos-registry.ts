...
export const MODULOS_REGISTRY: ModuloRegistryItem[] = [
  ...
  { id: 'gestaoOnboarding',      label: 'Onboarding',               href: '/PainelAlpha/GestaoOnboarding',                                              iconName: 'Sparkles',      category: 'admin',       permission: null,                allowedRoles: ['Admin', 'CEO'],                                 img: '/arquivo.png',        desc: 'Templates de boas-vindas para novos colaboradores.',   tag: 'RH',         color: 'from-indigo-600/20' },
];
