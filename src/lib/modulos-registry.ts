...
export const MODULOS_REGISTRY: ModuloRegistryItem[] = [
  ...
  { id: 'chatBotAlpha',          label: 'ChatBot Alpha',            href: '/PainelAlpha/ChatBotAlpha',                                                  iconName: 'Bot',           category: 'admin',       permission: 'chatBotAlpha',      desc: 'Conversas do ChatBot Alpha e acesso administrativo à infraestrutura (Adminer, Redis, MailHog).', tag: 'ChatBot', color: 'from-emerald-600/20' },
];
