 ...
 * entrada; "molduras do slide" e "efeitos do slide" ainda não têm schema/catálogo — registrado
 * como pendência consciente em `.bibble/memory/decisions.md`, não implementado aqui. */
  ...
  return (
    <div className="flex h-full flex-col gap-4 overflow-y-auto p-4">
      ...
      <div className="rounded-lg border border-white/5 bg-slate-900/40 px-3 py-2.5 text-[10px] leading-relaxed text-slate-600">
        Molduras do slide e efeitos globais ainda não estão disponíveis — chegam em uma fase futura, junto do catálogo de molduras.
      </div>
    </div>
  );
}
